...
export default function UsersListsPage() {
	...
	const activeUsers = mockUsers.filter((p) => p.status === "active")
	const suspendedProperties = mockUsers.filter((p) => p.status === "suspended")

	const currentUsers = activeTab === "active" ? activeUsers : suspendedProperties
						...
						<div className="p-6 border-b">
							<div className="flex flex-row justify-between gap-4">
								<div className="flex items-center gap-8">
									...
									>
										<span className="font-medium">Suspended User</span>
										<span className="bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full text-sm">
