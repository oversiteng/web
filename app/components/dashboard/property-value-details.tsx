...
const actionButtons = [
	...
	{ id: "timeline/expert-review", label: "Expert Review", icon: "Star" },
	{ id: "timeline/policy-updates", label: "State Policy Updates", icon: "FileText" },
	{ id: "landmarks", label: "Landmarks", icon: "MapPin" },
	{ id: "timeline/word-on-street", label: "Word on the Street", icon: "MessageSquare" },
	{ id: "timeline/community-update", label: "Community update", icon: "Users" },
		...
		return (
			<div className="min-h-screen bg-gray-50">
				...
				<button
					...
					className="px-6 py-3 bg-[#448C74] text-white rounded-lg hover:bg-[#357a63] transition-colors"
				>
					Add Review
				</button>
		...
		<div className="min-h-screen bg-gray-50">
			...
			<header className="px-4 md:px-6 py-4">
				<div className="flex items-center justify-between">
					<div className="flex flex-col md:flex-row md:items-center justify-between">
						<div className="flex items-center gap-4 mb-4 md:mb-0">
							<button onClick={handleBackClick} className="flex items-center gap-2 text-gray-600 hover:text-gray-900 cursor-pointer">
