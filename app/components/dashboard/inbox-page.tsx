	...
	return (
		<div className="min-h-screen bg-gray-50">
			...
			<div className="flex flex-col gap-4 bg-white rounded-lg">
				{/* Filter Tabs */}
				<div className="p-1 rounded-lg flex  items-start min-w-[18.125rem]">
					<div className="flex gap-4 border rounded-lg border-[#E9EAEB]">
						...
						<button
							...
							className={`cursor-pointer px-6 py-4 text-sm font-medium border-b-2 transition-colors flex items-center justify-center gap-2 ${activeTab === "unread"
								? "border-[#ECF4F1] shadow-md text-[#306251] bg-[#FFFFFF] rounded-[0.625rem]"
								: "border-transparent text-gray-500 hover:text-gray-700"
								}`}
						>
							Unread ({unreadCount}){unreadCount > 0 && <div className="w-2 h-2 bg-[#448C74] rounded-full" />}
						</button>
					</div>
