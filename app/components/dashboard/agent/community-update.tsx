...
export default function CommunityUpdate({ isMobile = false }: CommunityUpdateProps) {
	...
	if (isMobile) {
		return (
			<div className="min-h-screen bg-gray-50">
				<OverViewBreadCrumbs property={"GreenLand Estate"} page={"Community Update"} />
							...
							{communityUpdates.map((update) => (
								<div key={update.id} className="flex gap-4">
									...
									<div className="flex flex-col items-center">
										...
										{update.id !== communityUpdates[communityUpdates.length - 1].id && (
		...
		<div className="min-h-screen  flex flex-col gap-6">
			...
			<div className="flex flex-col gap-4">
				...
				<div className="bg-white rounded-lg shadow-sm p-6">
					<div className="flex items-center justify-between mb-6">
						<h2 className="text-base font-medium text-[#212A3B]">Community Update</h2>
						<button
							onClick={handleFiltersClick}
							className="flex items-center gap-2 px-4 py-2"
						>
