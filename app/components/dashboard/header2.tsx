...
export function Header({ onMenuClick, isMobile = false }: HeaderProps) {
	...
	return (
		<>
			<header className="bg-white px-4 md:px-6 py-4 sticky top-0 z-50">
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-4">
						{isMobile && (
							<button onClick={onMenuClick} className="p-2 bg-gray-100 rounded-lg flex md:hidden cursor-pointer">
								...
								<div className="absolute right-0 mt-2 w-[18.75rem] py-2 bg-white border border-gray-200 rounded-xl shadow-lg z-50">
									<div className="p-6 border-b border-gray-100">
										<div className="flex items-center gap-3">
											...
											<div>
												<p className="font-medium text-[#474E5C] text-sm">Timothy Daniels</p>
												<p className="text-xs text-[#474E5C] font-normal">Standard</p>
											</div>
										</div>
									</div>
